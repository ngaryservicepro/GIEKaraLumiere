...
export default function ClubsView({
  ...
  const handleExportCSV = () => {
    ...
    link.setAttribute("download", `GIE_Kara_Lumier_Clubs_${new Date().toISOString().split('T')[0]}.csv`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between pb-4 border-b border-gray-200 dark:border-gray-800 gap-4">
        <div>
          ...
          <p className={`text-sm ${textClass}`}>
            Gérer les différents clubs et associations sportives ou artistiques rattachés au GIE Kara Lumier.
          </p>
        </div>
